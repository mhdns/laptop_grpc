...
// This is a server side test, there are no network calls made
func TestServerCreateLaptop(t *testing.T) {
	...
	laptopInvalidID.Id = "Jibberish"

	laptopDuplicate := sample.NewLaptop()
	storeDuplicate := service.NewInMemoryLaptopStore()
	storeDuplicate.Save(laptopDuplicate)

	// table driven test to test multiple test cases
	testCases := []struct {
		name   string
		laptop *pb.Laptop
